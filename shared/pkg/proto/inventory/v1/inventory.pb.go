...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB0Z.InventoryService/pkg/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	3,  // 0: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	6,  // 1: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
