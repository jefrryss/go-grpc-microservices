...
// NotificationMethod describes a notification destination.
...
// RegisterRequest contains new user data.
...
// RegisterResponse contains the created user UUID.
...
// LoginResponse contains a session UUID.
...
// WhoamiRequest can carry a session for non-metadata clients.
...
// WhoamiResponse contains the current user identity.
...
// GetUserRequest identifies a user.
...
// GetUserResponse contains a user profile.
...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\"Q\n" +
	...
	"\x05login\x18\x02 \x01(\tR\x05login\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12N\n" +
	"\x14notification_methods\x18\x04 \x03(\v2\x1b.auth.v1.NotificationMethodR\x13notificationMethods2\x80\x03\n" +
	"\vAuthService\x12a\n" +
	...
	"\x06Whoami\x12\x16.auth.v1.WhoamiRequest\x1a\x17.auth.v1.WhoamiResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/v1/auth/whoami\x12_\n" +
	"\aGetUser\x12\x17.auth.v1.GetUserRequest\x1a\x18.auth.v1.GetUserResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/api/v1/users/{user_uuid}BLZJgithub.com/jefrryss/go-grpc-microservices/shared/pkg/proto/auth/v1;auth_v1b\x06proto3"
